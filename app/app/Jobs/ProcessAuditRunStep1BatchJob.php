...
class ProcessAuditRunStep1BatchJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(AuditRunService $auditRunService): void
    {
        ...
        $auditRunService->processStep1Batch($run, $this->itemIds);
    }
    ...
    public function failed(\Throwable $exception): void
    {
        ...
        $auditRunService->recoverStep1BatchItemIdsWithoutContent($run, $this->itemIds, $exception->getMessage());
        $auditRunService->dispatchStep1Batches($run);
    }
}
