...
class UpdateAuditSettingsRequest extends FormRequest
{
    ...
    {
        return [
            'aiProvider' => ['required', 'string', 'in:openai,deepseek,gemini,gemini_deep_research'],
            'aiModel' => ['nullable', 'string', 'max:160'],
            'step2AiProvider' => ['required', 'string', 'in:openai,deepseek,gemini,gemini_deep_research'],
            'step2AiModel' => ['nullable', 'string', 'max:160'],
            'step3AiProvider' => ['required', 'string', 'in:openai,deepseek,gemini,gemini_deep_research'],
            'step3AiModel' => ['nullable', 'string', 'max:160'],
            'step2FormatterProvider' => ['required', 'string', 'in:openai,deepseek,gemini'],
            'step2FormatterModel' => ['nullable', 'string', 'max:160'],
            'step3FormatterProvider' => ['required', 'string', 'in:openai,deepseek,gemini'],
            'step3FormatterModel' => ['nullable', 'string', 'max:160'],
            'fastAiProvider' => ['required', 'string', 'in:openai,deepseek,gemini,gemini_deep_research'],
            'fastAiModel' => ['nullable', 'string', 'max:160'],
            'fastFormatterProvider' => ['required', 'string', 'in:openai,deepseek,gemini'],
            'fastFormatterModel' => ['nullable', 'string', 'max:160'],
            'step3FlowMode' => ['required', 'string', 'in:standard,audit_deep_research'],
            'auditPipelineMode' => ['required', 'string', 'in:standard,fast'],
            'fastBatchSize' => ['required', 'integer', 'min:1', 'max:100'],
            ...
            'deepResearchFormatterProvider' => ['required', 'string', 'in:openai,deepseek,gemini'],
            'deepResearchFormatterModel' => ['required', 'string', 'max:160'],
            'modelPricing' => ['sometimes', 'array'],
            'modelPricing.*.provider' => ['required_with:modelPricing', 'string', 'in:openai,deepseek,gemini,gemini_deep_research,perplexity'],
