...
export async function fetchAuditBoard(websiteId: string): Promise<AuditBoard> {
  ...
  return {
    ...
    systemAi: {
      ...
      fastAiProvider: systemAi.fastAiProvider ?? systemAi.step2AiProvider ?? systemAi.aiProvider,
      fastAiModel: systemAi.fastAiModel ?? systemAi.step2AiModel ?? systemAi.aiModel ?? null,
      fastFormatterProvider: systemAi.fastFormatterProvider ?? systemAi.step2FormatterProvider ?? "gemini",
      fastFormatterModel: systemAi.fastFormatterModel ?? systemAi.step2FormatterModel ?? "gemini-2.5-flash",
...
export function normalizeAuditRun(run: AuditRun): AuditRun {
  return {
    ...
    fastAiProvider: run.fastAiProvider ?? run.step2AiProvider ?? run.aiProvider ?? "openai",
    fastAiModel: run.fastAiModel ?? run.step2AiModel ?? run.aiModel ?? null,
    fastFormatterProvider: run.fastFormatterProvider ?? run.step2FormatterProvider ?? "gemini",
    fastFormatterModel: run.fastFormatterModel ?? run.step2FormatterModel ?? "gemini-2.5-flash",
