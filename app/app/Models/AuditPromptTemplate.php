        ...
        return [
            ...
            self::STEP_ONPAGE_AUDIT => [
                ...
                'developer_prompt' => implode("\n", [
                    ...
                    'contentRevisionDirection: string 3–5 câu. Câu đầu bắt buộc ghi rõ hướng xử lý (Viết lại | Audit Content | Giữ nguyên | Redirect), sau đó nêu lý do và các bước chỉnh sửa thực tế.',
