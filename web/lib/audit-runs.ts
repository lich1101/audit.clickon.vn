...
export async function fetchAuditBoard(websiteId: string): Promise<AuditBoard> {
  ...
  return {
    ...
    systemAi: {
      ...
      fastAiProvider: systemAi.fastAiProvider ?? "deepseek",
      fastAiModel: systemAi.fastAiModel ?? "deepseek-v4-flash",
      fastFormatterProvider: systemAi.fastFormatterProvider ?? "deepseek",
      fastFormatterModel: systemAi.fastFormatterModel ?? "deepseek-v4-flash",
...
export function normalizeAuditRun(run: AuditRun): AuditRun {
  return {
    ...
    fastAiProvider: run.fastAiProvider ?? "deepseek",
    fastAiModel: run.fastAiModel ?? "deepseek-v4-flash",
    fastFormatterProvider: run.fastFormatterProvider ?? "deepseek",
    fastFormatterModel: run.fastFormatterModel ?? "deepseek-v4-flash",
