...
const variables = [
  ...
  { token: "{{research_items_json}}", description: "Kết quả research provider bước 3A cho từng URL trong chunk deep research." },
  ...
  { token: "{{research_json}}", description: "JSON nghiên cứu SERP/đối thủ/intent/freshness từ provider research bước 3A." },
