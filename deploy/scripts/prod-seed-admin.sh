...
# POSIX sh — chạy bằng: sh deploy/scripts/prod-seed-admin.sh [email] [password] [name]
...
# POSIX sh không có mảng — dùng positional parameters.
set -- clickon:create-admin "$EMAIL" "$PASSWORD" "--name=$NAME"
